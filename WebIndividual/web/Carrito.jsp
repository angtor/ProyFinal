<%-- 
    Document   : Carrito
    Created on : 14/11/2018, 09:25:09 PM
    Author     : win 10
--%>
   ...
   <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="Carrito.jsp"><i class="fas fa-shopping-cart" aria-hidden="true"></i></a></li>
                    ...
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="media-heading"> Autor: <a href="#">Autor X</a></h5>
								<h5 class="media-heading"> Editorial: <a href="#">Editorial X</a></h5>
